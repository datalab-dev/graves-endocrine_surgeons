...
(run_duration<-Sys.time()-start_time) #print to the console how long the processs took

write.csv(results_rurality_analysis, "rurality_analysis_2023-03-03-1730.csv") #writ the summary table to a csv file
